...
// The autogenerated part of this file mirrors the TPM 2.0 command signatures verbatim, so
// commands with many parameters are unavoidable. Scoped to this file rather than the crate
// so handwritten code is still linted.
...
impl Tpm2 {
    pub fn async_methods(&mut self) -> AsyncMethods<'_> {
